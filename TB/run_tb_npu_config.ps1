...
$TestFile = Join-Path $ScriptDir "tb_npu_config_test.v"
$OutputDir = Join-Path $ScriptDir "npu_config_test_output"
...
Write-Host "  NPU Config模块测试运行器" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# Compile the testbench using Icarus Verilog
$compile_args = @(
    "-o", (Join-Path $OutputDir "tb_npu_config"),
    "-I", $RTL_Dir,
    $TestFile,
